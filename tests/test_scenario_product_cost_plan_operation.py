...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(product_cost.cost == plan.products_cost, True)
        self.assertEqual(operations_cost.cost == plan.operations_cost, True)
        self.assertEqual(plan.operations_cost, Decimal('150.0000'))
        self.assertEqual(
            plan.cost_price == plan.products_cost + plan.operations_cost, True)
